...
interface AbstractControlTyped<T> extends AbstractControl {
    ...
    get<V = unknown | any>(path: Array<string | number> | string): AbstractControlTyped<V> | null;
    setValue<V>(value: V extends T ? V : any, options?: { onlySelf?: boolean; emitEvent?: boolean }): void;
    patchValue<V>(value: V extends Partial<T> ? V : any, options?: { onlySelf?: boolean; emitEvent?: boolean }): void;
    reset<V>(value?: V extends Partial<T> ? V : any, options?: { onlySelf?: boolean; emitEvent?: boolean }): void;
}
